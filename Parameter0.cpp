...
#define IF_NOTES
...
#ifdef IF_NOTES
		real inputParameters[50];//最多可以输入50个参数
		std::ifstream fileIn;
		...
		std::cout << "\t" << "reconstructionOrder" << "\t" << reconstructionOrder << std::endl;
		std::cout << "\t" << "isContinue" << "\t" << "\t" << isContinue << std::endl;
		std::cout << "\t" << "isPeriodicBoundary" << "\t" << isPeriodicBoundary << std::endl;
		std::cout << "\t" << "isViscous" << "\t" << "\t" << isViscous << std::endl;
		std::cout << "\t" << "EPS" << "\t" << "\t" << EPS << std::endl;
		std::cout << "\t" << "isImplicitTimeMarching" << "\t" << isImplicitTimeMarching << std::endl;
		std::cout << "\t" << "nStepTimeMarching" << "\t" << nStepTimeMarching << std::endl;
		std::cout << "------------------------------------------------------------------" << std::endl;
